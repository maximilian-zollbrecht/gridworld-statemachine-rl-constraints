...
agent = DeepQAgentStates(env, discount_factor=0.9,
                   ...
                   log_file="D:\\Masterarbeit\\masterarbeit\\models\\boatrace2\\boatrace-dqn-temp",
                   train_cycle=30,
                   batch_size=300,
                   # ignore_on_wrong_state=True,
                   reward_update=reward_update,
...
plot(log_file="D:\\Masterarbeit\\masterarbeit\\models\\boatrace2\\boatrace-dqn-temp", episode_group=8)
