...
BoxEnvNoStates.register()

env = gym.make(BoxEnvNoStates.name)
env.reset()
...
agent = DeepQAgentStates(env, discount_factor=0.9,
                         ...
                         explore_rate_decay=0.995,
                         explore_rate_min=0.2,
                         # model_file='D:\\Masterarbeit\\masterarbeit\\models\\box\\box-dqn-base.h5',
                         log_file="D:\\Masterarbeit\\masterarbeit\\models\\box\\box-nostates-dqn-rewardsub2",
                         train_cycle=50,
                         batch_size=1000,
                         # ignore_on_wrong_state=True,
                         reward_update=reward_update,
...
log_files = EnvironmentTest(agent, 10000, 4, True, True).run_multiple(10)

print("logged into: ", log_files)

#myplot.plot(log_file="D:\\Masterarbeit\\masterarbeit\\models\\box\\box-qtable", episode_group=16)

myplot.plot_multiple(log_files, limit_steps=10000, plot_steps=125, plot_steps_test=125)
